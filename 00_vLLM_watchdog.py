"""
00_vLLM_watchdog.py — restart 00_vLLM_label_full.py if it crashes.
Runs in foreground; kill with Ctrl+C.
"""
import subprocess, time, os, sys
from datetime import datetime

SCRIPT = "00_vLLM_label_full.py"
LOG    = "logs/00_vLLM_label_full_log.txt"
